...
import com.kidueck.Util.TimeUtil;
 ...
 */
public class FeedMyFragment extends Fragment implements  AdapterView.OnItemClickListener, AbsListView.OnScrollListener, View.OnClickListener {
    ...
    public static FeedMyFragment newInstance() {
    ...
    public class ListViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(convertView == null){
                ...
                holder.imageCnt = (TextView) convertView.findViewById(R.id.tv_feed_image_cnt);
            ...
            try {
                Date tempDate = (Date) sdFormat.parse(stringDate);
                String resultDate = TimeUtil.formatTimeString(tempDate);
                holder.date.setText(resultDate);
            } catch (ParseException e) {
                e.printStackTrace();
                holder.date.setText("오류");
            }
            ...
            holder.imageCnt.setText(String.valueOf(data.getImageCnt()));
            holder.attachdImg.setImageDrawable(null);

            if(data.isImage){
                final String imageUrl = new URLInfo().getPostImgUploadUrl() + data.getPostingId() + "/1.jpg";
                Picasso.with(getContext()).load(imageUrl)
                        .into(holder.attachdImg);
            }
    ...
    private class ViewHolder {
        ...
        public TextView imageCnt; //이미지 갯수
    }//view holder class ();;
    ...
    private class GetPostingList extends AsyncTask<Boolean, Void, Void> {
        ...
        protected Void doInBackground(Boolean... params) {
            try
            {
                ...
                vector = postingRepository.getMyPostingList(getUserId(), pageNumber);
            }
            catch (Exception e) {
                e.printStackTrace();
            }
