...
//                        Bitmap resize = Bitmap.createScaledBitmap(orgImage, 300, 400, true);
                        ...
                        //크기줄이기
                        Bitmap resize = Bitmap.createScaledBitmap(rotatedBitmap, 300, 400, true);
    ...
    public class SubmitPost extends AsyncTask<Boolean, Void, Void> {
        ...
        protected Void doInBackground(Boolean... params) {
            try
            {
                ...
                submitResult = postingRepository.writePost(getUserId(), inputContent, isImage);
            }
            catch (Exception e) {
                e.printStackTrace();
            }
