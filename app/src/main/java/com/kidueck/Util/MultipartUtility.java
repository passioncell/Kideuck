...
//        httpConn.setRequestProperty("Test", "Bonjour");
    ...
    public void addFilePart(String fieldName, File uploadFile)
        ...
        //ROTATE
        Bitmap bitmap = checkOrientation(uploadFile.getAbsolutePath());
        SaveBitmapToFileCache(bitmap, uploadFile.getAbsolutePath());
    ...
    public Bitmap checkOrientation(String imageUrl) throws IOException {
        //이미지 Orientation 확인후 회전해서 저장

        BitmapFactory.Options bounds = new BitmapFactory.Options();
        bounds.inJustDecodeBounds = true;
        BitmapFactory.decodeFile(imageUrl, bounds);

        BitmapFactory.Options opts = new BitmapFactory.Options();
        Bitmap bm = BitmapFactory.decodeFile(imageUrl, opts);
